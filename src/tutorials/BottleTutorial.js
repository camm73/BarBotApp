...
const slides = [
    {
        key: 'remove',
        title: 'Remove Bottle',
        text: 'Pressing the "Remove Bottle" button will empty all excess alcohol or mixer from the pump lines back into the bottle.\n\nFor long lines you may need to run this twice.',
      ...
      },
      {
        key: 'add',
        title: 'Add Bottle',
        text: 'Once you have a new bottle connected, holding down this button will pump out the liquid until it is primed.\n\n1. Place a cup below the spout.\n2. Hold the button until the first drops of liquid appear\n3. Release the button.',
        textStyle: {fontSize: 20},
        backgroundColor: '#59b2ab',
      }
]
